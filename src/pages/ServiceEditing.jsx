    ...
    return (
        <main className="service-page container">
            ...
            <div className="service-page__description">
                Edição de Vídeo, criamos e editamos os vídeos para sua empresa... Nós fazemos vídeos para o Youtube, vídeos para o instagram, vídeos para o Facebook, Vídeos para o Linkedin e Vídeos para Anúncios em qualuqer rede social citada. 
            </div>
